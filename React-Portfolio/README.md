...
## State Management
1.Projects-stotres all projects data.

2.SearchTerm-stores user input for filtering.

3.ProjectForm-sends new project to App.

4.SearchBar-updates searchterm in App.

5.ProjectList-receives filtered projects.
